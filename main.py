    ...
    async def send_welcome(message: Message):
        await message.answer("Привет! Выбери эпоху для изучения:", reply_markup=get_epoch_keyboard())
    ...
    async def process_epoch(callback: CallbackQuery):
        ...
        await callback.message.answer(f"Вы выбрали эпоху: {epoch.upper()}. Теперь выберите уровень сложности:")
